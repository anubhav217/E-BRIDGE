...
//query
$result = mysql_query("INSERT INTO `timetable` (subject,description,image) VALUES('$subject','$description','$buffer')") or die ('Query is invalid: ' . mysql_error());
...
if (mysql_num_rows($result) > 0) {
 ...
 //$row = mysql_fetch_array($result);
   while ($row = mysql_fetch_array($result)) {
        ...
        array_push($response["timetable"], $product);
    ...
    // no products found
    $response["success"] = 0;
    $response["timetable"] = "Invalid details";
